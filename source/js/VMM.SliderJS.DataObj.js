...
if (typeof VMM.SliderJS !== 'undefined' && typeof VMM.SliderJS.DataObj == 'undefined') {
	VMM.SliderJS.DataObj = {
		data_obj: {},
		model_array: [],
		getData: function (raw_data) {
			VMM.SliderJS.DataObj.data_obj = {};
			...
			if (type.of(raw_data) == "object") {
				...
				VMM.SliderJS.DataObj.parseJSON(raw_data);
			} else if (type.of(raw_data) == "string") {
				if (raw_data.match("%23")) {
					trace("DATA SOURCE: TWITTER SEARCH");
					VMM.SliderJS.DataObj.model.tweets.getData("%23medill");
				} else if (	raw_data.match("spreadsheet") ) {
					trace("DATA SOURCE: GOOGLE SPREADSHEET");
					VMM.SliderJS.DataObj.model.googlespreadsheet.getData(raw_data);
				} else if (raw_data.match("storify.com")) {
					trace("DATA SOURCE: STORIFY");
					VMM.SliderJS.DataObj.model.storify.getData(raw_data);
				...
				VMM.SliderJS.DataObj.parseHTML(raw_data);
			} else {
